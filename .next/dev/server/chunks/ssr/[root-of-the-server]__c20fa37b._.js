...
function useAppDispatch() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AppDispatchContext);
    if (!context) {
...
"[project]/lib/data/users.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/data/users.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function useAuth() {
    ...
    const login = (email, password)=>{
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["demoUsers"].find((u)=>u.email === email && u.password === password);
        if (user) {
            const authUser = {
                id: user.id,
                name: user.name,
...
const getInitialState = ()=>({
        pizzaStock: Object.fromEntries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$pizzas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pizzas"].map((p)=>[
                p.id,
                p.stock
            ])),
        drinkStock: Object.fromEntries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$pizzas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["drinks"].map((d)=>[
                d.id,
                d.stock
            ])),
        dessertStock: Object.fromEntries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$pizzas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["desserts"].map((d)=>[
                d.id,
                d.stock
            ]))
    });
...
function StockProvider({ children }) {
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useReducer"])(stockReducer, getInitialState());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c20fa37b._.js.map