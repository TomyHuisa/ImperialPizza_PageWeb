...
(()=>{
    const e = new Error("Cannot find module '@/lib/pocketbase'");
...
function useAuth() {
    ...
    const register = async (name, email, password, phone)=>{
        try {
            ...
            const errorMessage = error?.data?.data?.email?.message || error?.message || "El registro falló. El correo puede estar en uso.";
            return {
                success: false,
                error: errorMessage
            };
...
function PointsProvider({ children }) {
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$lib$2f$store$2f$auth$2d$store$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    const [is_loading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [points_history, setPointsHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    // Cargar puntos del usuario
    const refreshPoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setIsLoading(true);
            if (!user?.id) {
            ...
            if (pb) {
                try {
                    ...
                    setPointsHistory(history.map((record)=>({
    ...
    const getCurrentUserPoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            if (!user?.id) {
                const savedPoints = localStorage.getItem("imperial_points");
    ...
    // Agregar puntos
    const addPoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (amount, description)=>{
        try {
            if (amount <= 0) return;
            if (!user?.id) {
                // Modo local
    ...
    // Usar puntos
    const usePoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ImperialPizza_PageWeb$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (amount, description)=>{
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__481bb52b._.js.map