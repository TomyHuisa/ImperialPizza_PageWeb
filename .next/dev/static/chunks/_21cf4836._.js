...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            // 1. Revisar si ya hay una sesión activa guardada por PocketBase
            const loadAuth = {
                "AuthProvider.useEffect.loadAuth": ()=>{
            ...
            loadAuth();
            // 2. Escuchar cambios en la autenticación (ej: si se loguea en otra pestaña o expira el token)
...
function useAuth() {
    ...
    const login = async (email, password)=>{
        ...
        try {
            // Intentamos hacer login contra la colección 'users' de PocketBase
    ...
    const logout = ()=>{
        // Limpiamos la sesión de PocketBase
        pb.authStore.clear();
        dispatch({
            type: "LOGOUT"
        });
...
//# sourceMappingURL=_21cf4836._.js.map